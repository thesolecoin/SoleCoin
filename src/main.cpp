...
const string strMessageMagic = "SoleCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    int64_t nSubsidy = 0 * COIN;
     ...
     if(nHeight < 1  ) nSubsidy = 0 * COIN;
else if(nHeight < 100) nSubsidy = 100 * COIN;
else if(nHeight <3100) nSubsidy = 800 * COIN;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in SoleCoin
    bool fStrictPayToScriptHash = true; // Always active in SoleCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SoleCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Solecoin dev 2014-08-09";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x72ab12564d5a7e21fc86d4782ea4ecc4cd4bcd47684f16217a52a5f33b808271"));
